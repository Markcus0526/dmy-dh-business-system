...
public final class HorizontalPager extends ViewGroup {
	...
	// Added by KHM. 20140-08-05 15:48
	private OnHorScrolledListener horScrollListener = null;
	public void setScrollChangeListener(OnHorScrolledListener listener)
	{
		horScrollListener = listener;
	}
	/////////////////////////////////////////////////////////////////////////////////////////////////
...
//		}
		...
		if (mFirstLayout) {
			...
			// Added by KHM. 2014-08-05
			if (horScrollListener != null)
				horScrollListener.onScrolled();
		...
		switch (action) {
			case MotionEvent.ACTION_MOVE:
				...
				if (mTouchState == TOUCH_STATE_HORIZONTAL_SCROLLING) {
					...
					// Changed by JinXueMin. 2014.02.07
					// boolean yMoved = yDiff > mTouchSlop;  // Original code
					boolean yMoved = yDiff > xDiff;
					////////////////////////////////////////////////////////
