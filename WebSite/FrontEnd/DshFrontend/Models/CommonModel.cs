...
namespace DshFrontend.Models
{
    ...
    public class CommonModel
    {
        ...
        {
            _db = new DshDBModelDataContext(ConfigurationManager.ConnectionStrings["DshFrontendConnectionString"].ConnectionString);
            return _db;
        }
        ...
        public static string GetFirstActionForRole()
        {
            ...
            if (udata.Count() > 0)
            {
                ...
                if (roles.Count() > 0)
                {
                    if (roles[0] == "managerdata")
                        return "UserData";
                    else if (roles[0] == "physiologydata")
                        return "UserData";
                    else if (roles[0] == "sportrecord")
                        return "Record";
                    else if (roles[0] == "foodrecord")
                        return "Record";
                    else if (roles[0] == "weightrecord")
                        return "Record";
                    else if (roles[0] == "base")
                        return "BaseData";
                    else if (roles[0] == "news")
                        return "Health";
                    else if (roles[0] == "question")
                        return "QA";
        ...
        public static  string GenerateRandomCode(int len)
        {
            ...
            StringBuilder randomTextBuilder = new StringBuilder(len);
            string textChars = "0123456789";
