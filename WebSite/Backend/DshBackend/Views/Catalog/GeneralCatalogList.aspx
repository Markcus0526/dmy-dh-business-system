...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Catalog/AddGeneralCatalog">
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Catalog/RetrieveCatalogList?type=1",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Catalog/EditGeneralCatalog/' + o.aData[9] + '">' +
		    ...
		    function refreshTable() {
		        ...
		        oSettings.sAjaxSource = rootUri + "Catalog/RetrieveCatalogList?type=1" + "&kindid=" + kind_id;
