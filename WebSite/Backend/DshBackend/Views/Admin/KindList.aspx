...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Admin/AddKind">
	                <i class="ace-icon fa fa-plus bigger-120 blue"></i>添加类型
                </a>
			...
			<table id="tbldata" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th style="min-width:150px;">类型名称</th>
						<th style="min-width:150px;">类型图片</th>
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Admin/RetrieveKindList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '';
				                if (o.aData[2] == null || (o.aData[2] + ''.length < 1))
				                    rst = '<img src="/Content/img/noimage.gif" width = "60" height="60"/>';
                                else
                                    rst = '<img src ="' + rootUri + o.aData[2] + '" width = "60" height="60">';
				                return rst;
				            },
				            sClass: 'center'
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Admin/EditKind/' + o.aData[3] + '">' +
                                    '<i class="ace-icon fa fa-pencil bigger-120"></i>' +
                                    '</a>&nbsp;&nbsp;';
				                rst += '<a class="btn btn-xs btn-danger" onclick="processDel(' + o.aData[3] + ')">' +
