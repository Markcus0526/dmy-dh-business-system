	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="userpwd">用户密码：</label>
				<div class="col-sm-9">
                    <div class="clearfix">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="password" id="confirmpwd" name="confirmpwd" placeholder="请输入确认密码" class="input-large form-control" <% if (userinfo != null) { %>value="<%= userinfo.password %>"<% } %> />
                    </div>
				</div>
			</div>
			<div class="form-group">
	...
	<script type="text/javascript">
	    function redirectToListPage(status) {
	        if (status.indexOf("error") != -1) {
	            ...
	            window.location = rootUri + "Admin/AdminList";
	        }
	    }
	    jQuery(function ($) {
	        $('.loading-btn')
	    ...
	    function checkUserName() {
	        ...
	        $.ajax({
	            async: false,
	            type: "GET",
	            url: rootUri + "Admin/CheckUniqueAdminname",
	            dataType: "json",
	            data: {
	                username: username,
                    rid: rid
