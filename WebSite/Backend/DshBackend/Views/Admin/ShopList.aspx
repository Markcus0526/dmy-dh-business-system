...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Admin/AddShop">
	                <i class="ace-icon fa fa-plus bigger-120 blue"></i>添加商户
                </a>
			...
			<table id="tbldata" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th style="min-width:150px;width:250px;">商户帐号</th>
						<th>所在城市</th>
						<th>商家名称</th>
						<th>商家地址</th>
						<th>商家电话</th>
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Admin/RetrieveShopList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Admin/EditShop/' + o.aData[9] + '">' +
