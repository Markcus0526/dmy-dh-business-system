...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Admin/AddRole">
	                <i class="ace-icon fa fa-plus bigger-120 blue"></i>添加角色
                </a>
			...
			<table id="tbldata" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th style="width:250px;min-width:150px;">角色名称</th>
						<th>所属权限</th>
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Admin/RetrieveRoleList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Admin/EditRole/' + o.aData[3] + '">' +
