...
<div class="row">
	<div class="col-xs-12">
       <!-- <p class="alert alert-info">
		...
		<div>
            <p>
              <!--  <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>User/AddUser">
	                <i class="ace-icon fa fa-plus bigger-120 blue"></i>添加管理员
                </a>-->
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "User/RetrieveUserList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
                        {
                            ...
                            fnRender: function (o, v) {   // o, v contains the object and value for the column
                                ...
                                rst += '<img src="<%= ViewData["rootUri"] %>' + o.aData[7] + '" style="max-height:100px;" />';
                        ...
                        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'User/EditUser/' + o.aData[8] + '">' +
