...
<% var card = (tbl_card)ViewData["card"]; %>
	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="username">题目：</label>
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="title" name="title" placeholder="请输入题目" class="input-large form-control" <% if (card != null) { %>value="<%= card.title %>"<% } %> />						    
					    
                    </div>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="content">内容输入：</label>
				<div class="col-sm-9">
                    <div class="clearfix">
					 <textarea id="content" name="content" class="col-md-4 adjust-left form-control" style="width: 370px;
                            height: 100px; max-width: 370px; min-width: 370px;"><% if (ViewData["uid"] != null)
