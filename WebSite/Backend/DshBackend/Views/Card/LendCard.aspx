                ...
                <div class="tab-content">
                    <div class="tabbable">
                        <ul class="nav nav-tabs padding-16">
                            <li class="active"><a data-toggle="tab" href="#status0">个人小额贷款管理</a></li>
                            <li><a data-toggle="tab" href="#status1">企业小额贷款管理</a></li>
                            <li><a data-toggle="tab" href="#status2">添加信息内容</a></li>                            
                        </ul>
                        <div class="tab-content profile-edit-tab-content">
                            ...
                            <div id="status2" class="tab-pane">
                                 <div>
                                    <p>
                                       <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Card/AddUserLendCard">
	                                        <i class="ace-icon fa fa-plus bigger-120 blue"></i>添加信息
                                        </a>
                                        <a class="btn btn-white btn-warning btn-bold" style="display:none;" id="btnbatchdel2" onclick="processDel2();">
                                            <i class="ace-icon fa fa-trash-o bigger-120 orange"></i>批量删除
                                        </a>
                                    </p>
		                        </div>
        ...
        jQuery(function ($) {
            oTable0 =
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Card/RetrieveUserLendCardInfoList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Card/EditUserLendCardInfo/' + o.aData[8] + '">' +
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Card/RetrieveOrgLendCardInfoList",
				    "oLanguage": {
				        "sUrl": rootUri + "Content/i18n/dataTables.chinese.txt"
				    },
				    //bAutoWidth: false,
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Card/EditOrgLendCardInfo/' + o.aData[11] + '">' +
                                    '<i class="ace-icon fa fa-pencil bigger-120"></i>' +
                                    '</a>&nbsp;&nbsp;';
				                rst += '<a class="btn btn-xs btn-danger" onclick="processDel1(' + o.aData[11] + ')">' +
                                    '<i class="ace-icon fa fa-trash-o bigger-120"></i>' +
                                    '</a>';
				                return rst;
				            },
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Card/RetrieveUserLendCardDataist",
				    "oLanguage": {
				        "sUrl": rootUri + "Content/i18n/dataTables.chinese.txt"
				    },
				    //bAutoWidth: false,
				    ...
				    "aoColumnDefs": [
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                return '<label class="position-relative">' +
								    '<input type="checkbox" value="' + o.aData[0] + '" name="selcheckbox" class="ace" onclick="showBatchBtn2()" />' +
								    '<span class="lbl"></span>' +
							        '</label>';
				            },
				            sClass: 'center'
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Card/EditUserLendCard/' + o.aData[5] + '">' +
                                    '<i class="ace-icon fa fa-pencil bigger-120"></i>' +
                                    '</a>&nbsp;&nbsp;';
				                rst += '<a class="btn btn-xs btn-danger" onclick="processDel2(' + o.aData[5] + ')">' +
                                    '<i class="ace-icon fa fa-trash-o bigger-120"></i>' +
                                    '</a>';
				                return rst;
				            },
            ...
            $(document).on('click', '#tbldata2 thead th input:checkbox', function () {
                var that = this;
                $(this).closest('table').find('tr > td:first-child input:checkbox')
					.each(function () {
					    this.checked = that.checked;
                ...
                bootbox.dialog({
                    ...
                    buttons: {
                        ...
                        main: {
                            ...
                            callback: function () {
                                $.ajax({
                                    url: rootUri + "Card/DeleteOrgLendCard",
                                    data: {
                                        "delids": selected_id
                                    },
                                    type: "post",
