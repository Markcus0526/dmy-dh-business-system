                ...
                <div class="tab-content">
                    <div class="tabbable">
                        <ul class="nav nav-tabs padding-16">
                            <li class="active"><a data-toggle="tab" href="#status0">银行卡业务办理</a></li>
                            <li><a data-toggle="tab" href="#status1">银行卡信息目录</a></li>                            
                        </ul>
                        <div class="tab-content profile-edit-tab-content">
                            ...
                            <div id="status1" class="tab-pane">
                                 <div>
                                    <p>
                                       <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Card/AddBankCard">
        ...
        jQuery(function ($) {
            oTable0 =
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Card/RetrieveBankCardInfoList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Card/EditBankCardInfo/' + o.aData[8] + '">' +
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Card/RetrieveBankCardDataist",
				    "oLanguage": {
				        "sUrl": rootUri + "Content/i18n/dataTables.chinese.txt"
				    },
				    //bAutoWidth: false,
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Card/EditBankCard/' + o.aData[5] + '">' +
                                    '<i class="ace-icon fa fa-pencil bigger-120"></i>' +
                                    '</a>&nbsp;&nbsp;';
