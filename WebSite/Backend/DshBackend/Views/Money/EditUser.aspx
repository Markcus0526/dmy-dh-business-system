	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="validation-form">
			<div class="form-group">
				...
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="username" name="username" placeholder="请输入姓名" class="input-large form-control" <% if (userinfo != null) { %>value="<%= userinfo.username %>"<% } %> disabled/>
                    </div>
				</div>
			</div>			
            <div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="username">积分数值：</label>
				<div class="col-sm-9">
                    <div class="clearfix">
					<input type="text" id="score" name="score" placeholder="请输入积分数值" class="input-large form-control" <% if (userinfo != null) { %>value="<%= userinfo.score %>"<% } %> />
                    </div>
				</div>
			</div>
	...
	<script type="text/javascript">
   	    function redirectToListPage(status) {
	        if (status.indexOf("error") != -1) {
                ...
                window.location = rootUri + "Money/UserList";
