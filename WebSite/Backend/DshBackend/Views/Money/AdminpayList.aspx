...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Money/AddAdminpay">
	                <i class="ace-icon fa fa-plus bigger-120 blue"></i>添加新应收付
                </a>
        ...
        <div class="widget-box" style="height:65px;padding-top:10px;">
			...
			<table style="width:100%;">
				<tr>
                    ...
                    <td width="100px" align="right">
                        <label for="form-field-select-3">分类:&nbsp;&nbsp;&nbsp;</label>
                    </td>
                    <td width="260px">
                        <select class="select2" id="type" data-placeholder="Click to Choose...">
					...
					<td width="150px">
                        <label class="inline">
							<input type="checkbox" class="ace" id="real" />
							<span class="lbl"> 是否实收实付</span>
						</label>
                    </td>  
					<td width="80px">
			...
			<table id="tbldata" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th>名称</th>
						<th>联系号码</th>
						<th style="min-width:150px;max-width:200px;">理由</th>
						<th>应收/应付</th>
						<th>应收应付金额</th>
						<th>实收实付金额</th>
						<th>实收实付日期</th>
        ...
        <table style="width:100%;">
				<tr>                
                    ...
                    <td width="260px">						
                        <span><span id="total_gain"><% =ViewData["total_gain"] %></span>元</span>
                    </td>
                    <td width="100px" align="right">
                        <label >总应付：&nbsp;&nbsp;&nbsp;</label>
                    </td>
                    <td width="260px">
                        <span><span id="total_pay"><% =ViewData["total_pay"] %></span>元</span>
                    </td>    
			    </tr>
		    </table>
        </div>
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Money/RetrieveAdminpayList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '';
				                if (parseInt(o.aData[4], 10) == 0)
				                    rst = '<span class="label label-info">应收</span>';
				                else
				                    rst = '<span class="label label-warning">应付</span>';
				                return rst;
				            },
				            sClass: 'center'
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Money/EditAdminpay/' + o.aData[8] + '">' +
                                    '<i class="ace-icon fa fa-pencil bigger-120"></i>' +
                                    '</a>&nbsp;&nbsp;';
				                rst += '<a class="btn btn-xs btn-danger" onclick="processDel(' + o.aData[8] + ')">' +
		    ...
		    function refreshTable() {
		        var type = $("#type").val();
		        var real = document.getElementById("real").checked == true ? 1 : 0;

		        oSettings = oTable.fnSettings();
		        oSettings.sAjaxSource = rootUri + "Money/RetrieveAdminpayList?type=" + type + "&real=" + real + "&start=" + startdate.format('YYYY-MM-DD') + "&end=" + enddate.format('YYYY-MM-DD');
		            ...
		            bootbox.dialog({
		                ...
		                buttons: {
		                    ...
		                    main: {
		                        ...
		                        callback: function () {
		                            $.ajax({
		                                url: rootUri + "Money/DeleteAdminpay",
		                                data: {
		                                    "delids": selected_id
		                                },
		                                type: "post",
		    ...
		    function getTotalAdminpay() {
		        $.ajax({
		            type: "GET",
		            url: rootUri + "Money/GetTotalAdminpay",
		            dataType: 'json',
		            data: {
		            ...
		            success: function (data) {
		                if (data != null) {
		                    $("#total_gain").html(data.total_gain);
