...
<div class="row">
	<div class="col-xs-12">
		...
		<div>
            <p>
                <a class="btn btn-white btn-info btn-bold" href="<%= ViewData["rootUri"] %>Shop/AddShoppay">
		...
		<script type="text/javascript">
		    ...
		    jQuery(function ($) {
				...
				.dataTable({
				    "bServerSide": true,
				    "bProcessing": true,
				    "sAjaxSource": rootUri + "Shop/RetrieveShoppayList",
				    "oLanguage": {
				    ...
				    "aoColumnDefs": [
				        ...
				        },
				        {
				            ...
				            fnRender: function (o, v) {   // o, v contains the object and value for the column
				                var rst = '<a class="btn btn-xs btn-info" href="' + rootUri + 'Shop/EditShoppay/' + o.aData[8] + '">' +
		    ...
		    function refreshTable() {
		        ...
		        oSettings.sAjaxSource = rootUri + "Shop/RetrieveShoppayList?type=" + type + "&real=" + real + "&start=" + startdate.format('YYYY-MM-DD') + "&end=" + enddate.format('YYYY-MM-DD');
		            ...
		            bootbox.dialog({
		                ...
		                buttons: {
		                    ...
		                    main: {
		                        ...
		                        callback: function () {
		                            $.ajax({
		                                url: rootUri + "Shop/DeleteShoppay",
		                                data: {
		                                    "delids": selected_id
		                                },
		                                type: "post",
		    ...
		    function getTotalShoppay() {
		        $.ajax({
		            type: "GET",
		            url: rootUri + "Shop/GetTotalShoppay",
		            dataType: 'json',
		            data: {
