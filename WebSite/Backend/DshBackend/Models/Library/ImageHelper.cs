...
namespace DshBackend.Models.Library
{
    ...
    {
        public const string KIND = "60,60";  
        public const string CATALOG = "640,640";  
        public const string USER = "128,128";
        public const string DEVICE = "100,100";
        public const string RECOMMEND = "660,290";  
    };
